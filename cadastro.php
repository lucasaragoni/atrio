    ...
    <div class="container">
        <div class="content">
            ...
            <div class="formulario">
                <form action="admin/functions/adicionar_usuario.php" method="post">
                    <div class="form-group">
                        <label>Tipo de perfil:</label> <br>

                        <select name="tipoperfil" id="">
                            <option value="">Selecione seu perfil </option>
                            <option value="2">Hemocentro</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email" placeholder="Insira seu email ou do seu hemocentro">
                            </div>
                        </div>
                    ...
                    <div class="info">
                        ...
                        <a href="login.php" class="senha">Já possuo Login</a>
                    </div>
